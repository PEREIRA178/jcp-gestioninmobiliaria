	...
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Var2 := templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
			...
			if d.PriceSub != "" {
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/templates/web/propiedad.templ`, Line: 126, Col: 20}
				}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/templates/web/propiedad.templ`, Line: 145, Col: 21}
			}
			_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString(templ.EscapeString(templ_7745c5c3_Var4))
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 11, "</h1><p class=\"detail-loc\"><span class=\"ms ms-sm\" style=\"color:var(--jcp-primary)\">location_on</span> ")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/templates/web/propiedad.templ`, Line: 148, Col: 21}
			}
			...
			if d.Lat != 0 && d.Lng != 0 {
				templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 15, "<div class=\"section-block\"><h2><div class=\"section-icon\"><span class=\"ms ms-sm\">map</span></div>Ubicación</h2>")
				if templ_7745c5c3_Err != nil {
					return templ_7745c5c3_Err
				}
				if d.Comuna != "" {
					templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 16, "<div style=\"margin-bottom:12px\"><span class=\"zone-pill\"><span class=\"ms ms-sm\">location_on</span> ")
					if templ_7745c5c3_Err != nil {
						return templ_7745c5c3_Err
					}
					...
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/templates/web/propiedad.templ`, Line: 167, Col: 86}
					}
				...
				templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 18, "<div class=\"map-box\" data-map=\"detail\" data-lat=\"")
				if templ_7745c5c3_Err != nil {
					return templ_7745c5c3_Err
				}
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/templates/web/propiedad.templ`, Line: 173, Col: 46}
				}
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/templates/web/propiedad.templ`, Line: 174, Col: 46}
				}
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/templates/web/propiedad.templ`, Line: 175, Col: 30}
				}
				...
				if d.Comuna != "" {
					templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 22, "<div class=\"map-overlay-badge\"><span class=\"ms ms-sm\" style=\"color:var(--jcp-primary)\">location_on</span> ")
					if templ_7745c5c3_Err != nil {
						return templ_7745c5c3_Err
					}
					...
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/templates/web/propiedad.templ`, Line: 180, Col: 21}
					}
				...
				templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 24, "</div><p class=\"map-hint\"><span class=\"ms ms-sm\">lock</span> Dirección exacta disponible al contactar al corredor</p></div>")
				if templ_7745c5c3_Err != nil {
					return templ_7745c5c3_Err
				}
			}
			if d.AmenitiesHTML != "" {
				templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 25, "<div class=\"section-block\"><h2><div class=\"section-icon\"><span class=\"ms ms-sm\">auto_awesome</span></div>Prestaciones</h2><div class=\"prestaciones\">")
				if templ_7745c5c3_Err != nil {
					return templ_7745c5c3_Err
				}
			...
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 27, "</div><aside class=\"contact-card\" id=\"contactar\"><div style=\"font-size:15px;font-weight:800;color:var(--on-surface);margin-bottom:14px\">Precio y condiciones</div><div class=\"price-detail-row\"><span class=\"pr-label\">Precio</span> <span class=\"pr-val big\">")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			templ_7745c5c3_Err = templ.Raw(string(d.PriceHTML)).Render(ctx, templ_7745c5c3_Buffer)
			...
			if d.PriceSub != "" {
				templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 29, "<div class=\"price-detail-row\"><span class=\"pr-label\">Referencia</span> <span class=\"pr-val\">")
				if templ_7745c5c3_Err != nil {
					return templ_7745c5c3_Err
				}
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/templates/web/propiedad.templ`, Line: 209, Col: 41}
				}
			...
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 31, "<div style=\"margin-top:16px\">")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			if d.WhatsappHTML != "" {
				...
				templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 32, "<a href=\"https://wa.me/56912345678\" class=\"sb-cta sb-wa\" target=\"_blank\" rel=\"noopener\"><span class=\"ms ms-sm\">chat</span> Consultar por WhatsApp</a> ")
				if templ_7745c5c3_Err != nil {
					return templ_7745c5c3_Err
				}
			}
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 33, "<button class=\"sb-cta sb-tel\"><span class=\"ms ms-sm\">phone</span> Llamar al corredor</button> <button class=\"sb-cta sb-form\"><span class=\"ms ms-sm\">mail</span> Enviar consulta</button></div>")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			if d.Lat != 0 && d.Lng != 0 {
				templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 34, "<div style=\"margin-top:20px;padding-top:20px;border-top:1px solid var(--outline-var)\"><div style=\"font-size:13px;font-weight:700;color:var(--on-surface);margin-bottom:8px;display:flex;align-items:center;gap:5px\"><span class=\"ms ms-sm\" style=\"color:var(--jcp-primary)\">map</span> Zona de la propiedad</div><div class=\"sidebar-map-box\" data-map=\"detail-mini\" data-lat=\"")
				if templ_7745c5c3_Err != nil {
					return templ_7745c5c3_Err
				}
				var templ_7745c5c3_Var12 string
				templ_7745c5c3_Var12, templ_7745c5c3_Err = templ.JoinStringErrs(fmt.Sprintf("%.6f", d.Lat))
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/templates/web/propiedad.templ`, Line: 231, Col: 46}
				}
				_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString(templ.EscapeString(templ_7745c5c3_Var12))
				if templ_7745c5c3_Err != nil {
					return templ_7745c5c3_Err
				}
				templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 35, "\" data-lng=\"")
				if templ_7745c5c3_Err != nil {
					return templ_7745c5c3_Err
				}
				var templ_7745c5c3_Var13 string
				templ_7745c5c3_Var13, templ_7745c5c3_Err = templ.JoinStringErrs(fmt.Sprintf("%.6f", d.Lng))
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/templates/web/propiedad.templ`, Line: 232, Col: 46}
				}
				_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString(templ.EscapeString(templ_7745c5c3_Var13))
				if templ_7745c5c3_Err != nil {
					return templ_7745c5c3_Err
				}
				templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 36, "\"></div><p class=\"map-hint\" style=\"justify-content:center;margin-top:6px\"><span class=\"ms ms-sm\">info</span> Ubicación aproximada</p></div>")
				if templ_7745c5c3_Err != nil {
					return templ_7745c5c3_Err
				}
			}
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 37, "</aside></div></div></main>")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			return nil
		})
		templ_7745c5c3_Err = layouts.Base(d.Titulo+" — JCP Gestión Inmobiliaria", true).Render(templ.WithChildren(ctx, templ_7745c5c3_Var2), templ_7745c5c3_Buffer)
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		return nil
