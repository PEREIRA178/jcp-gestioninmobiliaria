...
func PropiedadDetail(d PropiedadData) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Var2 := templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
			...
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 7, "</div><div class=\"pb-loc\"><span class=\"ms ms-sm\" style=\"opacity:.65\">location_on</span> ")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			var templ_7745c5c3_Var4 string
			templ_7745c5c3_Var4, templ_7745c5c3_Err = templ.JoinStringErrs(d.Direccion)
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/templates/web/propiedad.templ`, Line: 167, Col: 19}
			}
			_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString(templ.EscapeString(templ_7745c5c3_Var4))
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 8, "</div></div><div class=\"detail-grid\"><div><div class=\"detail-header\" style=\"margin-bottom:20px\"><div class=\"op-chips\">")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			...
			templ_7745c5c3_Var5, templ_7745c5c3_Err = templ.JoinStringErrs(d.Titulo)
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/templates/web/propiedad.templ`, Line: 174, Col: 21}
			}
			_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString(templ.EscapeString(templ_7745c5c3_Var5))
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 10, "</h1><p class=\"detail-loc\"><span class=\"ms ms-sm\" style=\"color:#1D4ED8\">location_on</span> ")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			var templ_7745c5c3_Var6 string
			templ_7745c5c3_Var6, templ_7745c5c3_Err = templ.JoinStringErrs(d.Direccion)
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/templates/web/propiedad.templ`, Line: 177, Col: 21}
			}
			_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString(templ.EscapeString(templ_7745c5c3_Var6))
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 11, "</p></div><div class=\"feats-grid\">")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			...
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 12, "</div><div class=\"section-block\"><h2><div class=\"section-icon\"><span class=\"ms ms-sm\">description</span></div>Descripción</h2><div class=\"desc\">")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			...
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 13, "</div></div><div class=\"schedule-section\" data-prop-title=\"")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			var templ_7745c5c3_Var7 string
			templ_7745c5c3_Var7, templ_7745c5c3_Err = templ.JoinStringErrs(d.Titulo)
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/templates/web/propiedad.templ`, Line: 188, Col: 62}
			}
			_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString(templ.EscapeString(templ_7745c5c3_Var7))
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 14, "\"><h3 class=\"schedule-title\">Agendar una visita</h3><p class=\"schedule-sub\">Elegí fecha, horario y te confirmamos por WhatsApp.</p><form id=\"schedule-form\" data-wa-phone=\"")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			var templ_7745c5c3_Var8 string
			templ_7745c5c3_Var8, templ_7745c5c3_Err = templ.JoinStringErrs(d.WhatsappPhone)
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/templates/web/propiedad.templ`, Line: 191, Col: 63}
			}
			_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString(templ.EscapeString(templ_7745c5c3_Var8))
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 15, "\"><div class=\"sched-layout\"><div class=\"sched-cal-col\"><input id=\"sched-date-fp\" type=\"hidden\" name=\"fecha\"><div id=\"sched-cal\"></div></div><div class=\"sched-right\"><div><div class=\"sched-slots-label\">Horario disponible</div><div class=\"sched-slots\"><button type=\"button\" class=\"sched-slot active\" data-time=\"09:00\">09:00</button> <button type=\"button\" class=\"sched-slot\" data-time=\"10:00\">10:00</button> <button type=\"button\" class=\"sched-slot\" data-time=\"11:00\">11:00</button> <button type=\"button\" class=\"sched-slot\" data-time=\"12:00\">12:00</button> <button type=\"button\" class=\"sched-slot\" data-time=\"14:00\">14:00</button> <button type=\"button\" class=\"sched-slot\" data-time=\"15:00\">15:00</button> <button type=\"button\" class=\"sched-slot\" data-time=\"16:00\">16:00</button> <button type=\"button\" class=\"sched-slot\" data-time=\"17:00\">17:00</button></div></div><div class=\"sched-field\"><label>Tu nombre</label> <input class=\"sched-input\" type=\"text\" name=\"nombre\" placeholder=\"Juan Carlos\" required></div><div class=\"sched-field\"><label>Tu teléfono</label> <input class=\"sched-input\" type=\"tel\" name=\"telefono\" placeholder=\"+56 9 1234 5678\"></div><button type=\"submit\" class=\"sched-btn\"><span class=\"ms ms-sm ms-fill\">calendar_month</span> Confirmar visita por WhatsApp</button></div></div></form></div>")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			if d.Lat != 0 && d.Lng != 0 {
				templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 16, "<div class=\"section-block\" style=\"margin-top:24px\"><h2><div class=\"section-icon\"><span class=\"ms ms-sm\">map</span></div>Ubicación</h2>")
				if templ_7745c5c3_Err != nil {
					return templ_7745c5c3_Err
				}
				if d.Comuna != "" {
					templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 17, "<div style=\"margin-bottom:12px\"><span class=\"zone-pill\"><span class=\"ms ms-sm\">location_on</span> ")
					if templ_7745c5c3_Err != nil {
						return templ_7745c5c3_Err
					}
					var templ_7745c5c3_Var9 string
					templ_7745c5c3_Var9, templ_7745c5c3_Err = templ.JoinStringErrs(d.Comuna)
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/templates/web/propiedad.templ`, Line: 234, Col: 86}
					}
				...
				templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 19, "<div class=\"map-box\" data-map=\"detail\" data-lat=\"")
				if templ_7745c5c3_Err != nil {
					return templ_7745c5c3_Err
				}
				var templ_7745c5c3_Var10 string
				templ_7745c5c3_Var10, templ_7745c5c3_Err = templ.JoinStringErrs(fmt.Sprintf("%.6f", d.Lat))
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/templates/web/propiedad.templ`, Line: 240, Col: 46}
				}
				...
				templ_7745c5c3_Var11, templ_7745c5c3_Err = templ.JoinStringErrs(fmt.Sprintf("%.6f", d.Lng))
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/templates/web/propiedad.templ`, Line: 241, Col: 46}
				}
				_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString(templ.EscapeString(templ_7745c5c3_Var11))
				if templ_7745c5c3_Err != nil {
					return templ_7745c5c3_Err
				}
				templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 21, "\" data-title=\"")
				if templ_7745c5c3_Err != nil {
					return templ_7745c5c3_Err
				}
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/templates/web/propiedad.templ`, Line: 242, Col: 30}
				}
				...
				if d.Comuna != "" {
					templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 23, "<div class=\"map-overlay-badge\"><span class=\"ms ms-sm\" style=\"color:#1D4ED8\">location_on</span> ")
					if templ_7745c5c3_Err != nil {
						return templ_7745c5c3_Err
					}
					var templ_7745c5c3_Var13 string
					templ_7745c5c3_Var13, templ_7745c5c3_Err = templ.JoinStringErrs(d.Comuna)
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/templates/web/propiedad.templ`, Line: 247, Col: 21}
					}
				...
				templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 25, "</div><p class=\"map-hint\"><span class=\"ms ms-sm\">lock</span> Dirección exacta disponible al contactar al corredor</p></div>")
				if templ_7745c5c3_Err != nil {
					return templ_7745c5c3_Err
				}
			}
			if d.AmenitiesHTML != "" {
				templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 26, "<div class=\"section-block\"><h2><div class=\"section-icon\"><span class=\"ms ms-sm\">auto_awesome</span></div>Prestaciones</h2><div class=\"prestaciones\">")
				if templ_7745c5c3_Err != nil {
					return templ_7745c5c3_Err
				}
			...
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 28, "</div><aside class=\"contact-card\" id=\"contactar\"><div style=\"font-size:15px;font-weight:700;color:#111827;margin-bottom:14px\">Precio y condiciones</div><div class=\"price-detail-row\"><span class=\"pr-label\">Precio</span> <span class=\"pr-val big\">")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			templ_7745c5c3_Err = templ.Raw(string(d.PriceHTML)).Render(ctx, templ_7745c5c3_Buffer)
			...
			if d.PriceSub != "" {
				templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 30, "<div class=\"price-detail-row\"><span class=\"pr-label\">Referencia</span> <span class=\"pr-val\">")
				if templ_7745c5c3_Err != nil {
					return templ_7745c5c3_Err
				}
				var templ_7745c5c3_Var14 string
				templ_7745c5c3_Var14, templ_7745c5c3_Err = templ.JoinStringErrs(d.PriceSub)
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/templates/web/propiedad.templ`, Line: 276, Col: 41}
				}
			...
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 32, "<div style=\"margin-top:16px\">")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			if d.WhatsappHTML != "" {
				...
				templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 33, "<a href=\"https://wa.me/56912345678\" class=\"sb-cta sb-wa\" target=\"_blank\" rel=\"noopener\"><span class=\"ms ms-sm\">chat</span> Consultar por WhatsApp</a> ")
				if templ_7745c5c3_Err != nil {
					return templ_7745c5c3_Err
				}
			}
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 34, "<button class=\"sb-cta sb-tel\"><span class=\"ms ms-sm\">phone</span> Llamar al corredor</button> <button class=\"sb-cta sb-form\"><span class=\"ms ms-sm\">mail</span> Enviar consulta</button></div>")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			if d.Lat != 0 && d.Lng != 0 {
				templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 35, "<div style=\"margin-top:20px;padding-top:20px;border-top:1px solid #F1F5F9\"><div style=\"font-size:13px;font-weight:700;color:#111827;margin-bottom:8px;display:flex;align-items:center;gap:5px\"><span class=\"ms ms-sm\" style=\"color:#1D4ED8\">map</span> Zona de la propiedad</div><div class=\"sidebar-map-box\" data-map=\"detail-mini\" data-lat=\"")
				if templ_7745c5c3_Err != nil {
					return templ_7745c5c3_Err
				}
				var templ_7745c5c3_Var15 string
				templ_7745c5c3_Var15, templ_7745c5c3_Err = templ.JoinStringErrs(fmt.Sprintf("%.6f", d.Lat))
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/templates/web/propiedad.templ`, Line: 298, Col: 46}
				}
				_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString(templ.EscapeString(templ_7745c5c3_Var15))
				if templ_7745c5c3_Err != nil {
					return templ_7745c5c3_Err
				}
				templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 36, "\" data-lng=\"")
				if templ_7745c5c3_Err != nil {
					return templ_7745c5c3_Err
				}
				var templ_7745c5c3_Var16 string
				templ_7745c5c3_Var16, templ_7745c5c3_Err = templ.JoinStringErrs(fmt.Sprintf("%.6f", d.Lng))
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/templates/web/propiedad.templ`, Line: 299, Col: 46}
				}
				_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString(templ.EscapeString(templ_7745c5c3_Var16))
				if templ_7745c5c3_Err != nil {
					return templ_7745c5c3_Err
				}
				templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 37, "\"></div><p class=\"map-hint\" style=\"justify-content:center;margin-top:6px\"><span class=\"ms ms-sm\">info</span> Ubicación aproximada</p></div>")
				if templ_7745c5c3_Err != nil {
					return templ_7745c5c3_Err
				}
			}
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 38, "</aside></div></div></div><link rel=\"stylesheet\" href=\"https://cdn.jsdelivr.net/npm/flatpickr/dist/flatpickr.min.css\"><script src=\"https://cdn.jsdelivr.net/npm/flatpickr\" defer></script> <script src=\"https://cdn.jsdelivr.net/npm/flatpickr/dist/l10n/es.js\" defer></script> <script>\n\t\t\t(function(){\n\t\t\t  function initSchedule(){\n\t\t\t    var cal=document.getElementById('sched-cal');\n\t\t\t    if(!cal||!window.flatpickr)return;\n\t\t\t    var fp=flatpickr(cal,{\n\t\t\t      inline:true,\n\t\t\t      minDate:'today',\n\t\t\t      locale:flatpickr.l10ns.es,\n\t\t\t      disableMobile:true,\n\t\t\t      onChange:function(dates,dateStr){\n\t\t\t        var inp=document.getElementById('sched-date-fp');\n\t\t\t        if(inp)inp.value=dateStr;\n\t\t\t      }\n\t\t\t    });\n\t\t\t    // default to today\n\t\t\t    fp.setDate(new Date());\n\n\t\t\t    // time slot buttons\n\t\t\t    var selectedTime='09:00';\n\t\t\t    document.querySelectorAll('.sched-slot').forEach(function(btn){\n\t\t\t      btn.addEventListener('click',function(){\n\t\t\t        document.querySelectorAll('.sched-slot').forEach(function(b){b.classList.remove('active')});\n\t\t\t        btn.classList.add('active');\n\t\t\t        selectedTime=btn.dataset.time;\n\t\t\t      });\n\t\t\t    });\n\n\t\t\t    // form submit\n\t\t\t    var sf=document.getElementById('schedule-form');\n\t\t\t    if(sf){\n\t\t\t      sf.addEventListener('submit',function(e){\n\t\t\t        e.preventDefault();\n\t\t\t        var fecha=document.getElementById('sched-date-fp').value||new Date().toISOString().slice(0,10);\n\t\t\t        var nombre=sf.nombre.value.trim(),tel=sf.telefono.value.trim();\n\t\t\t        var propTitle=sf.closest('[data-prop-title]')?sf.closest('[data-prop-title]').dataset.propTitle:document.title;\n\t\t\t        var waPhone=sf.dataset.waPhone||'56912345678';\n\t\t\t        var text='Hola! Quiero agendar una visita para: '+propTitle+'\\nFecha: '+fecha+'\\nHora: '+selectedTime;\n\t\t\t        if(nombre)text+='\\nNombre: '+nombre;\n\t\t\t        if(tel)text+='\\nTeléfono: '+tel;\n\t\t\t        window.open('https://wa.me/'+waPhone+'?text='+encodeURIComponent(text),'_blank');\n\t\t\t      });\n\t\t\t    }\n\t\t\t  }\n\t\t\t  if(document.readyState==='loading'){\n\t\t\t    document.addEventListener('DOMContentLoaded',initSchedule);\n\t\t\t  } else {\n\t\t\t    // flatpickr loads deferred — wait for it\n\t\t\t    var t=setInterval(function(){\n\t\t\t      if(window.flatpickr){clearInterval(t);initSchedule();}\n\t\t\t    },50);\n\t\t\t  }\n\t\t\t}());\n\t\t</script>")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			return nil
